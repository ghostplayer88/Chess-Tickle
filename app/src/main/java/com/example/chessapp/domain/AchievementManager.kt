...
class AchievementManager(context: Context) {
    ...
    private val _achievements = mutableListOf(
        ...
        Achievement("campaign_lvl1_3stars", "Perfect Start", "Earn 3 Stars on Level 1 of Campaign Mode.", "⭐", "Campaign"),
        Achievement("campaign_10stars", "Star Collector", "Earn 10 total stars in Campaign Mode.", "⭐", "Campaign", maxProgress = 10),
        Achievement("campaign_20stars", "Star Veteran", "Earn 20 total stars in Campaign Mode.", "🌟", "Campaign", maxProgress = 20),
        Achievement("campaign_30stars", "Perfect Campaigner", "Earn all 30 stars in Campaign Mode!", "🏆", "Campaign", maxProgress = 30),
        Achievement("campaign_boss_3stars", "Boss Slayer", "Defeat Level 10 (The Chess Tickler) with 3 Stars.", "👑", "Campaign"),
        Achievement("campaign_speed_star", "Speed Demon", "Earn the Speed Star (under 30 turns) on 3 levels.", "⏱️", "Campaign", maxProgress = 3),
        Achievement("campaign_queen_star", "Royal Guard", "Earn the Queen Protection Star on 3 levels.", "🛡️", "Campaign", maxProgress = 3),
